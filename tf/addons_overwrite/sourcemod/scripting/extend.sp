...
public OnConfigsExecuted()
{
    ...
    old_round = GetConVarInt(g_Cvar_Maxrounds);
    old_frag  = GetConVarInt(g_Cvar_Fraglimit);
    old_win   = GetConVarInt(g_Cvar_Winlimit);
    old_time  = GetConVarInt(g_Cvar_Timelimit);
    old_capt  = GetConVarInt(g_Cvar_Capture);
}
